							...
							<div class="m-stack__item m-stack__item--fluid m-header-menu-wrapper">
								...
								<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light ">
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										<li class="m-menu__item <?=($this->uri->segment(1) === "dasbor")? "m-menu__item--active-tab": "";?> m-menu__item--submenu m-menu__item--tabs" m-menu-submenu-toggle="tab" aria-haspopup="true">
											<a href="" class="m-menu__link m-menu__toggle" title="">
											...
											<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
														<a href="<?=base_url();?>dasbor" class="m-menu__link ">
										...
										<li class="m-menu__item <?=($this->uri->segment(1) === "produk")? "m-menu__item--active-tab": "";?> m-menu__item--submenu m-menu__item--tabs" m-menu-submenu-toggle="tab" aria-haspopup="true">
											<a href="" class="m-menu__link m-menu__toggle" title="Non functional dummy link">
											...
											<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
														<a href="<?=base_url();?>produk" class="m-menu__link ">
										...
										<li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs" m-menu-submenu-toggle="tab" aria-haspopup="true">
											...
											<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
												...
												<ul class="m-menu__subnav">
													...
													<li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
														<a href="<?=base_url();?>order/add" class="m-menu__link ">
															<i class="m-menu__link-icon flaticon-alarm-1"></i>
