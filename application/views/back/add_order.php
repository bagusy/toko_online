...
<<<<<<< HEAD:application/views/back/add_order.php
            ...
            <div class="card">
                ...
                <div class="card-body">
                     ...
                     <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                                                              <select class="custom-select addr-select" data-section="province" name="province_id" required="">
                     ...
                     <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Kabupaten <span class="text-danger">*
                          	<script src="http://api.ruangpanji.com/kecamatan.php?kabkota_id=<kabkota_id>"></script>
...
<!-- end::Body
>>>>>>> 24d7017d176ddea817f272c079b90a704865d1ad:application/views/front/add_order.php
